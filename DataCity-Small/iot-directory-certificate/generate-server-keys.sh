...
export IOTDIR_SERVER_ORGANIZATION_NAME=Organization
export IOTDIR_SERVER_ORGANIZATION_UNIT=Unit
...
export IOTDIR_SERVER_PASSWORD=pass:password
export IOTDIR_SERVER_PK12_PASSWORD=pass:password
